  ...
  return (
    <div className="flex text-xl relative items-center">
      ...
      <div className="relative" ref={cartRef}>
        <FaShoppingCart
          className="lg:mx-6 lg:text-xl sm:text-xl text-lg mx-1 cursor-pointer"
          onClick={() => setIsCartOpen(!isCartOpen)}
        />
        {/* Badge luôn hiển thị, kể cả 0 */}
        <span
          className='absolute lg:left-10 left-4 -top-2.5 lg:-top-3 text-xs font-semibold bg-[#639eae]
